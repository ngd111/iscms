...
typedef boost::multi_index_container<
    employee,
    indexed_by<
        ordered_unique<tag<id>,  BOOST_MULTI_INDEX_MEMBER(employee,int,id_)>,
        ordered_unique<tag<name>,BOOST_MULTI_INDEX_MEMBER(employee,std::string,name_)>,
        ordered_unique<tag<address>, BOOST_MULTI_INDEX_MEMBER(employee,std::string,address_)>,
        hashed_unique<tag<id_hash>,  BOOST_MULTI_INDEX_MEMBER(employee,int,id_)>,
        hashed_unique<tag<name_hash>,  BOOST_MULTI_INDEX_MEMBER(employee,std::string,name_)>
    >
> employee_set;
...
int main()
{
    ...
    {
        const employee_set_ordered_by_id_index_t& index_id = get<id>(employee_set_);
    ...
    {
        const employee_set_ordered_by_name_index_t& index_name = get<name>(employee_set_);
    ...
    {
        employee_set_hashed_by_name_index_t& index_name = get<name_hash>(employee_set_);
